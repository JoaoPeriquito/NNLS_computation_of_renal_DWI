%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Thorarin Bjarnason
% 2006.08.01 (RegNNLS style)  Last modified 2008.04.28, confirm search
% method is the same as RegNNLS
%
% RegNNLS_Energy.m
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%{
    ...
    [ amplitudes, resnorm, resid] = ...
        RegNNLS_Energy(T2Basis, decay', ChiMin, ChiMax);
    %
    %%See result
    %Remove DC offset
...
function [ amplitudes, resnorm, resid ] ...
    = RegNNLS_Energy(NNLS_A, RawData, chi_min, chi_max)

%Construct the exponential kernel for NNLS
%Create regularizing portion
%THOR seems to get caught w/ >-5. Search algorithm could be improved.
%
