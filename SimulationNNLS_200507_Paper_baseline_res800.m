...
% 20.05.07 (NNLS & LS numerical simulations for Renal IVIM)  
%
% Script used to perform numerical simulations to gauge the performance of 
% the data-driven non-negative least squares (NNLS) approach using 
% conventional least square fitting (LS) as reference. The simulations 
% aimed at optimizing renal DWI protocols (number of b-values, SNR, 
% b-value range) for assessing tubular volume fraction for two 
% physiological conditions (baseline vs. challenge increasing 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Simulation - Steps: 300; NumSimulations =500; Baseline parameters; Restricted to b-value 800
...
[b_values] = optimizeBscale_800([frac_fastOpt diff_fast; frac_medOpt diff_med; frac_slowOpt diff_slow],number_of_b_values(h));
...
toc    
    ...
    save(['steps300_sim500_baseline_res800_' datestr(now) '.mat'])
    %toc./60
end
...
timeElapsed = toc./60
% figure, imagesc(AAA)
save('steps300_sim500_baseline_res800.mat')