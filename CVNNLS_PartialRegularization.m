%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Thomas Gladytz
% 2020.05.07 (Partial Regularized NNLS using cross validation)  
% A modified version of Thorarin Bjarnason CVNNLS function
%
% TG: Regularization is swithched off for all basis decays in NoRegPos
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Thorarin Bjarnason
...
function [ xOut, ChiUsed, resid ] = CVNNLS_PartialRegularization(A,Decay,NoRegPos)
